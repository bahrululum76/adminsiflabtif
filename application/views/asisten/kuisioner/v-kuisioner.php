    ...
    <div class="main-wrapper">
        ...
        <div class="col s12">
            <div class="main-panel">                            
                <div class="col s12">                        
                    <div class="center-align">
                        <a href="<?=base_url()?>asisten/kuisioner?menu=penilaian-diri" class="tombol-aplikasi nav__link teal lighten-5 black-text" style="font-weight:500"><i class="medium material-icons teal-text">person</i><br>Penilaian Diri</a>
                        <a href="<?=base_url()?>asisten/kuisioner?menu=penilaian-asisten" class="tombol-aplikasi nav__link indigo lighten-5 black-text" style="font-weight:500"><i class="medium material-icons indigo-text">group</i><br>Penilaian Asisten</a>                
                        <a href="<?=base_url()?>asisten/kuisioner?menu=nilai-saya" class="tombol-aplikasi nav__link amber lighten-5 black-text" style="font-weight:500"><i class="medium material-icons amber-text">assignment_ind</i><br>Lihat Nilai Saya</a>
                    </div>
                </div>
            </div>
        </div>            
