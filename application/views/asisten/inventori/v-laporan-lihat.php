        ...
        <div class="col s12">
            <div class="main-panel">
                ...
                <div class="right-align">
                    <a target="_blank" href="<?=base_url()?>asisten/inventori/cetak_inventori?rid=<?=$rid?>&lid=<?=$lid?>&laporan=<?=$laporan?>" type="button" class="tombol tombol-sm tombol-primary"><i class="material-icons left">print</i><span>Cetak Laporan</span></a>
                </div>                
