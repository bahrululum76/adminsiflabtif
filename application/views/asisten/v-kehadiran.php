...
<div class="col s12">
    <div class="main-wrapper">
        <div class="top-panel right-align">
            <span class="panel-title-1 left" style="margin-left: 36px; position: relative; top: 4px">Kehadiran Asisten</span>
        ...
        <div class="col s12">
            <div class="main-panel">
                <div class="head-panel">
                    <span style="font-weight: 500; margin-right: 16px">Kehadiran praktikum asisten</span>: <span style="font-weight:600;display:inline-block"><?= $user->asisten_nama ?></span>
                </div>
                <br>                  
                <div class="col s12">                        
                        ...
                        <table>                                    
                            ...
                            <tbody>                                    
                                <?php
                                    ...
                                    <?php
                                        for ($i=1; $i <= 10; $i++) { 
                                            $cek_asisten = $this->M_database->cekdataAbsen('t_absensi_asisten', 'asisten_id', 'jadwal_kode', 'pertemuan', $this->session->userdata('asisten_id'), $value->jadwal_kode, $i);
