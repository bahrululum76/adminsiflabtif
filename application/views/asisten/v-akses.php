...
<div class="col s12">
    <div class="main-wrapper">
        <div class="top-panel right-align">
            <span class="panel-title-1 left" style="margin-left: 36px; position: relative; top: 4px"></span>
        ...
        <div class="row">                                
            <div class="col s12 m12 l12">
                <div class="center-align">
                    <br>
                    <br>
                    <img src="<?=base_url()?>assets/images/access/denied-2.svg" alt="akses denied" class="img-denied">
                    <h1 class="msg-head">Akses ditolak</h1>
	                <p class="msg">Oops!, kamu tidak dapat mengakses halaman ini</p>
                </div>
            </div>                                               
        </div>
    </div>
