    ...
    <div class="main-wrapper">
        ...
        <div class="col s12">
            <div class="main-panel">
                <div>Selamat datang di halaman BAK Sistem Informasi Laboratorium Teknik Informatika <span style="font-weight:500">(SIFLABTIF)</span></div>           
                <div><span style="font-weight:600;font-size:16px;color:#196bff">SIFLABTIF</span>, di aplikasi ini anda dapat mengubah status pembayaran praktikum mahasiswa dan mengirim pesan kepada asisten.</div>
            </div>
        </div>
    </div>
</div>