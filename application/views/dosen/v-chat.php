<?php
    $grupKoorlab = pesanGrupDosen('koorlab', $user->dosen_id);
?> 
<div class="main-wrapper">
    ...
    <div class="row" style="padding: 0 8px">
        <div class="chat-contact">
            ...
            <!-- GRUP KOORLAB -->
            <div class="chat-user-box valign-wrapper chat-public row" id="koorlab">
                <div>
            ...
            <!-- DM ASISTEN -->
            <span class="panel-title-2" style="margin: 42px 0 12px;">DM Asisten</span>                
            <?php 
            foreach ($asisten->result() as $key => $value) {                      
                $dmAsisten = pesanPribadiDosen($user->dosen_id, $value->asisten_id);                                                                                                 
                ?>                
        ...
        <div class="chat-panel">
            <div class="chat-box">
                ...
                <div class="chat-input">
                    ...
                    <input type="text" hidden class="pengirim" value="<?= $user->dosen_nama ?>">
