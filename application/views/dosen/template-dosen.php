...
// Get User
    ...
    $jml_notif = $this->M_database->countWhere('t_pesan_status', array('pesan_penerima' => "dosen_$user->dosen_id"));
...
<div class="main-box">
   ...
   <?php endif  ?>
        ...
        <div class="sidenav-custom">
            ...
            <div><a class="link nav__link" data-senna-off="true" href="<?= base_url() ?>dosen/dashboard"><span class="menu-link"><i class="material-icons-outlined left">dashboard</i>Dashboard</span></a></div>
            <div><a class="link nav__link" href="<?= base_url() ?>dosen/jadwal-praktikum"><span class="menu-link"><i class="material-icons-outlined left">schedule</i>Jadwal Praktikum<span class="menu-link"></a></div>
            <div><a class="link nav__link" href="<?= base_url() ?>dosen/nilai-praktikum"><span class="menu-link"><i class="material-icons-outlined left">money</i>Nilai Praktikum<span class="menu-link"></a></div>
            <?php if ($this->session->userdata('jabatan_id') == 1) { ?>                
                <div><a class="link nav__link" href="<?= base_url() ?>dosen/kehadiran_asisten"><span class="menu-link"><i class="material-icons-outlined left">date_range</i>Kehadiran Asisten</span></a></div>
                <div><a class="link nav__link" href="<?= base_url() ?>dosen/inventori"><span class="menu-link"><i class="material-icons-outlined left">kitchen</i>Laporan Inventori</span></a></div>
            <?php } ?>
            <div><a class="link nav__link" href="<?= base_url() ?>dosen/chat"><span class="menu-link"><i class="material-icons-outlined left">chat</i>Pesan</span></a></div>
            <div><a class="link nav__link" href="<?= base_url() ?>dosen/catatan"><span class="menu-link"><i class="material-icons-outlined left">description</i>Catatan</span></a></div>            
            <div><a class="link nav__link" href="<?= base_url() ?>dosen/kuisioner"><span class="menu-link"><i class="material-icons left">people_alt</i>Kuisioner</span></a></div>            
        </div>
        <!-- Content Wrapper -->
        <div class="content-wrapper">
            ...
            <div style="position:sticky;z-index:10;top:0">
                <div class="dd-body dd-body-menu">
                    <a class="nav__link" href="<?=base_url()?>dosen/profil"><i class="material-icons left">face</i>Edit Profil</a>
                    <a class="nav__link" href="<?=base_url()?>dosen/password"><i class="material-icons left">vpn_key</i>Ganti Password</a>                    
	...
	<div class="modal-content modal-content-sm custom-modal-content">
		<div class="row">
			<div class="panel teal lighten-5">
                ...
                <div style="font-size: 16px;font-weight:600;margin-bottom:12px"><?=$user->dosen_nama?></div>                
