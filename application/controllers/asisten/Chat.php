...
class Chat extends CI_Controller {
	...
	public function index()
	{
        ...
        $this->template->load('asisten/template-asisten', 'asisten/v-chat', $data);
	}
	...
	function cek_pesan()
	{
		...
		if ($last_msg) {			
			...
			$last_msg['link'] = base_url().'asisten/chat?'.$last_msg['pesan_pengirim'];
		...
		foreach ($notif as $key => $value) {
			...
			$isi[1][$key]['link'] = base_url().'asisten/chat?'.$pengirim;
		}				
